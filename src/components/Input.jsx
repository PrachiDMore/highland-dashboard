      ...
      <div className={"w-full " + className}> 
        {
          !textarea ?
            ...
            :
            <textarea onChange={onChange} className='h-48 w-full px-3 py-2 outline-none resize-none rounded-md border border-accentGreen' id={id} cols="30" rows="10" value={value} placeholder={placeholder}></textarea>
        }
      </div>
